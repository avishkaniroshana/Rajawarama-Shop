...
@Entity
@Table(name = "dancing_request_extra_performers")
@Getter
@Setter
@NoArgsConstructor
public class DancingRequestExtraPerformer {
    ...
    @JoinColumn(name = "dp_request_id", nullable = false)
    private RequestDancingPackage dancingRequest;
