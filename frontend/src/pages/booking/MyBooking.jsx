...
const STYLES = `
  ...
  .mb-hero-badge{display:inline-flex;align-items:center;gap:7px;padding:5px 15px;border-radius:40px;
    border:1px solid rgba(201,168,76,.30);background:rgba(201,168,76,.07);color:var(--gold-l);
  ...
  .mb-body{max-width:900px;margin:0 auto;padding:44px 24px 90px}
  .mb-toolbar{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:14px;margin-bottom:22px}
  ...
  .mb-type-btn{padding:9px 18px;border-radius:7px;border:none;cursor:pointer;
    font-family:'DM Sans',sans-serif;font-size:.78rem;font-weight:500;letter-spacing:.05em;
  ...
  .mb-card-pkg{font-family:'Cormorant Garamond',serif;font-size:1.22rem;font-weight:700;color:var(--text);margin-bottom:5px}
  ...
  .mb-price-actions{display:flex;gap:8px;flex-wrap:wrap}
  ...
  .mb-details{padding:20px 22px;border-top:1px solid var(--border);background:rgba(250,247,244,.50)}
        ...
        <div className="mb-details">
          <div className="mb-detail-grid">
            <div className="mb-detail-section">
              ...
              {[["Hotel",booking.hotelName],["City",booking.nearestCity],["Date",fmtDate(booking.eventDate)],
      ...
      <div className="mb-card-head">
        <div style={{ flex:1 }}>
          <div className="mb-card-pkg">
            <Drum size={16} style={{ display:"inline",marginRight:"7px",color:"var(--indigo)",verticalAlign:"middle" }}/>
  ...
  return (
    <div className="mb-card">
      ...
      <div className="mb-card-head">
        <div style={{ flex:1 }}>
          <div className="mb-card-pkg">
            <Shirt size={15} style={{ display:"inline",marginRight:"7px",color:"var(--gold)",verticalAlign:"middle" }}/>
            Dress-Only Booking
          </div>
          <div className="mb-card-meta">
            <span className="mb-card-meta-item"><MapPin size={11}/> {booking.hotelName}, {booking.nearestCity}</span>
      ...
      <div className="mb-pricing-section">
        ...
        <div className="mb-pricing-subtotal">
          <span className="mb-pricing-subtotal-k">Dress Subtotal</span>
          <span className="mb-pricing-subtotal-v">Rs. {fmt(booking.bookingSubtotal)}</span>
        </div>
        <div className="mb-pricing-transport">
          <span className="mb-pricing-transport-k">
            <Truck size={12}/> Transport Price
